...
public interface BlacklistRepository extends JpaRepository<Blacklist, Long> {
	...
	/** @Query -> nativeQuery **/
	// @Query(value = "SELECT b.id, b.blacklisted_from, MAX(b.blacklisted_until) AS
	// blacklisted_until, b.user_id, b.post_id, b.comment_id, b.blacklist_reason_id,
	// b.reported_by, b.is_verified "
	// + "FROM blacklist b WHERE blacklisted_until > ?1 GROUP BY b.user_id",
	// nativeQuery = true)
	...
	Optional<Blacklist> findTopByBlacklistedUntilAfterAndUserOrderByBlacklistedUntilDesc(LocalDate now,
			Users userToFind);

	List<Blacklist> findByUserAndBlacklistedUntilIsNotNull(Users user);

	boolean existsByPostAndReporterAndCommentIdAndBlacklistReason(Post post, Users reporter, Long commentId,
